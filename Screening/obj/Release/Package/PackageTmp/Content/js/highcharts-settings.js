    ...
    Dashboard.Helpers.elementExists('.highcharts-pie-with-legend-money-map', function() {
        ...
        exporting: {
            ...
            series: [{
                ...
                data: [
                    {
                    name:OrderType[0].Label, //'Rush Orders',
                    color: 'RGBA(76, 175, 80, 1)',
                    y: OrderType[0].order
                   
                }, {
                    name: OrderType[1].Label,
                    ...
                    name: OrderType[2].Label,
                     color: 'RGBA(3, 169, 244, 1)',
                     y: OrderType[2].order
                   
                }, {
                    name: OrderType[3.].Label,
                     color: 'RGBA(86, 161, 245, 1.00)',
                     y: OrderType[3].order
                   
                },
                {
                    name: OrderType[4].Label,
                    color: 'RGBA(300, 150, 234, 1.00)',
                    y: OrderType[4].order

                },
                {
                    name: OrderType[5].Label,
